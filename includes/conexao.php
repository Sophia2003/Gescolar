<?php
/**
 * O arquivo conexão.php será usado por todas as páginas que nesessitem
 * realizar uma conexâo com o banco de dados. Para não termos que digitar
...
try {
    ...
    // Aqui criamos uma váríavel que abriga o objeto PDO, a conexão com o MySQL.
    $config = new PDO("mysql:host" . $host . ";dbname=" . $bd, $usuario, $senha, $config);
